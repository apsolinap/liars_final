...
function showSideBar(laboratory){
	if(laboratory == "chemistry"){
		...
		document.getElementById('sidebar-actions').innerHTML += '<ul class="nav"><li id="request" class="active"><a href="#"><i class="pe-7s-note2"></i><p onclick="request()">Requests</p></a></li><li id="inventory"><a href="#"><i class="pe-7s-box1"></i><p onclick="inventory()">Inventory</p></a></li><li id="accountability"><a href="#"><i class="pe-7s-piggy"></i><p onclick="accountability()">Accountability</p></a></li><li id="history"><a href="#"><i class="pe-7s-note"></i><p onclick="history()">History</p></a></li><li id="support"><a href="#"><i class="pe-7s-mail"></i><p onclick="support()">Contact Support</p></a></li> </ul>'
